...
$(document).ready(function () {
    var montlyArticlesUrl = app.Urls.montlyArticlesUrl;
    ...
    $.ajax({
        ...
        error: function () {
            toastr.error("An error occured while getting article analytics", "Error");
        }
    });
    ...
    $.ajax({
        ...
        error: function () {
            toastr.error("An error occured while getting category analytics", "Error");
        }
    });

    $.ajax({
        type: "GET",
        url: montlyArticlesUrl,
        datatype: "json",
        success: function (data) {
